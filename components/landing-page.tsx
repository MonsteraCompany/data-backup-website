        ...
        <main className="flex-1">
            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center text-center space-y-4">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none mb-4 bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
                  Protégez Vos Données avec la Vigilance de dataSafe
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="text-center">
                  ...
                  <p className="text-lg text-white mb-6">
                    Fort de 20 ans d'expérience dans le domaine de l'IT, notre société s'est spécialisée dans la
                    sauvegarde de données pour offrir une solution clé en main et 100% managée. Nous comprenons les
                    défis uniques auxquels font face les entreprises modernes en matière de protection des données, et
                    notre expertise nous permet de fournir un service sur mesure, fiable et sécurisé.
                  </p>
                  <p className="text-lg text-white">
                    Avec dataSafe, vous bénéficiez d'une tranquillité d'esprit totale. Notre équipe d'experts gère
                    l'ensemble du processus de sauvegarde, de la configuration initiale à la restauration des données en
                    cas de besoin. Nous nous engageons à offrir une solution complète qui s'adapte à vos besoins
                    spécifiques, vous permettant ainsi de vous concentrer sur votre cœur de métier en toute sérénité.
                  </p>
                </div>
          ...
          <section id="tarifs" className="w-full py-12 md:py-24 lg:py-32 bg-black">
            <div className="container px-4 md:px-6">
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
          ...
          <section id="temoignages" className="w-full py-12 md:py-24 lg:py-32 bg-black overflow-hidden">
            <div className="container px-4 md:px-6">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12 bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
                Ce Que Disent Nos Clients
              </h2>
              <div className="relative w-full overflow-hidden" ref={testimonialRef}>
                <div className="flex animate-scroll-continuous" style={{ width: "400%" }}>
                  {[...Array(2)].map((_, index) => (
                    <div key={index} className="flex space-x-6" style={{ width: "200%" }}>
                      ...
                      />
                      <TestimonialCard
                        quote="Depuis que nous utilisons dataSafe, nous n'avons plus jamais eu de souci avec nos données."
                        author="Pierre Durand"
                        company="Startup Tech Innovante"
                      />
                      <TestimonialCard
                        quote="La flexibilité de leur offre nous permet d'ajuster notre plan selon nos besoins. C'est parfait pour une entreprise en croissance."
                        author="Isabelle Moreau"
                        company="PME en Expansion"
                      />
                      <TestimonialCard
                        quote="Le support technique est réactif et compétent. Ils ont toujours su résoudre nos problèmes rapidement."
                        author="François Lemoine"
                        company="Cabinet Médical"
                      />
                      <TestimonialCard
                        quote="La facilité d'utilisation de leur plateforme est remarquable. Même les non-techniciens de notre équipe peuvent l'utiliser sans problème."
                        author="Claire Dubois"
                        company="Agence de Voyage en Ligne"
                      />
                      <TestimonialCard
                        quote="Nous apprécions particulièrement la transparence de dataSafe sur leurs pratiques de sécurité. Cela nous rassure énormément."
        ...
        <footer className="w-full py-12 bg-black border-t border-white/10">
          <div className="container px-4 md:px-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <p className="text-sm text-white/60">SIRET: 123 456 789 00019</p>
              <p className="text-sm text-white/60">TVA Intracommunautaire: FR 12 345678901</p>
